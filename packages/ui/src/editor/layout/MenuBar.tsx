...
const PLACEHOLDER_MENUS = ["Project", "Debug", "Editor", "Help"] as const;

/**
 * Top menu strip, mirroring Godot's Scene / Project / Debug / Editor / Help menus.
 * "Scene" is a real dropdown wired to the editor store; the rest remain
 * visual-only placeholders until a project backend exists to act on them.
 */
